...
This release reverts a commit to fix the `logical_quotas_get_collection_status` operation.

### Fixed

- Revert logic that unnecessarily escapes single quotes in GenQuery (#157).
